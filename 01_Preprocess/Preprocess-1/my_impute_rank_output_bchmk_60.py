...
with open('../feather_files/chars60_raw_imputed_cusip.feather', 'wb') as f:
...
with open('../feather_files/chars60_rank_no_impute_cusip.feather', 'wb') as f:
...
with open('../feather_files/chars60_rank_imputed_cusip.feather', 'wb') as f:
    feather.write_feather(df_rank, f)
