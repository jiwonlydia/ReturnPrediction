...
_ibes1_date = _ibes1.groupby(['ticker','cusip']).sdates.agg(['min', 'max']).reset_index().rename(columns={'min':'fdate', 'max':'ldate'})
...
with open('../feather_files/iclink.feather', 'wb') as f:
