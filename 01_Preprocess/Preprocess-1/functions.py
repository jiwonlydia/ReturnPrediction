...
def fillna_ind(df, method, ffi):
    ...
    ########### 내가 수정한 부분 ###########
    df_fill = df_fill.rename({'level_0':'date','level_1':'ffi%s'%ffi}, axis=1)
...
def fillna_all(df, method):
    ...
    for na_column in na_columns_list:
        ...
        if method == 'mean':
            ...
            None
    df_fill = df_fill.reset_index() # reset multiple index to date and ffi code
    df_fill = df_fill.rename({'index':'date'}, axis=1) # 내가 수정한 부분
...
def standardize(df):
    ...
    list_to_remove = ['ticker', 'permno', 'date', 'date', 'datadate', 'gvkey', 'sic', 'count', 'exchcd', 'shrcd', 'ffi49', 'ret',
                      'retadj', 'retx', 'lag_me']
